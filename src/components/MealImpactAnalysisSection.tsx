  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <p className="text-xs leading-relaxed text-zinc-500">
        ...
        <span className="font-medium text-zinc-600">{unit}</span>.
      </p>
      ...
      {loading && items.length === 0 && !error ? (
        ...
        <div className="flex items-start gap-3 rounded-2xl border border-dashed border-zinc-200 bg-surface/50 p-4">
